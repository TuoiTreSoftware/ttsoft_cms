...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\Contact\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\Contact\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\Contact\Http\Controllers\Admin';
