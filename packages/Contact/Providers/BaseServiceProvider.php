...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\Contact\Console\ContactCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Contact\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Contact\Providers\BaseEventServiceProvider::class,
    ];
    /**
