...
<div class="container-fluid">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h4 class="text-themecolor">Danh Sách Phiếu Báo Nợ ngân hàng</h4>
		</div>
		<div class="col-md-7 align-self-center text-right">
			<div class="d-flex justify-content-end align-items-center">
				<a href="{{ route('accounting.bao_no.get.add') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Tạo báo nợ ngân hàng</a>
			</div>
		</div>
	</div>
	<div class="row">
						...
						<table class="table table-bordered table-hover product-overview">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="{{ route('accounting.bao_no.get.edit',$val->getId()) }}" class="text-dark p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> <a href="{{ route('accounting.bao_no.get.delete',$val->getId()) }}" class="text-dark" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a></td>
								</tr>
