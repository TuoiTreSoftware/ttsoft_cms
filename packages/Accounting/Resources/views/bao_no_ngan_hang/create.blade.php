					...
					<form method="post" action="" id="my-form">
						...
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="doc_code" class="form-control" id="inputDoc_code" placeholder="Số phiếu nhập kho" value="BNNH{{ Carbon\Carbon::now()->year }}{{ Carbon\Carbon::now()->month }}" readonly="">
							</div>
							<div class="form-group col-md-4">
...
<script  type="text/javascript" >
	...
	$(document).ready(function() {
		...
		$("body").on('click','#btn_add_row',function() {
			...
			html += '<td><button type="button" href="javascript:void(0)" id="" class="btn btn-danger btn_clear btn-sm">Xóa</button></td>';
			html += '</tr>';
