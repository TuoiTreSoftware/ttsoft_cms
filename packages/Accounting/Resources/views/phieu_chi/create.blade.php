...
<div class="container-fluid">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h4 class="text-themecolor">Thêm Mới Phiếu Chi</h4>
		</div>
		<div class="col-md-7 align-self-center text-right">
			<div class="d-flex justify-content-end align-items-center">
				<a href="{{ route('accounting.phieu_chi.get.list') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Danh sách phiếu chi</a>
			</div>
		</div>
	</div>
	<div class="row">
					...
					<form method="post" action="" id="my-form">
						...
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="doc_code" class="form-control" id="inputDoc_code" placeholder="Số phiếu nhập kho" value="PC{{ Carbon\Carbon::now()->year }}{{ Carbon\Carbon::now()->month }}" readonly="">
							</div>
							...
							<div class="form-group col-md-4">
								<label for="inputtinh_trang" class=" control-label col-form-label">Tình trạng</label>
								<select class="form-control" id="inputtinh_trang" name="tinh_trang">
									...
									<table class="table table-hover table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td colspan="2"><input type="text" name="total" style="color: red;" readonly="" id="total" class="form-control total" value="0 vnđ"></td>
...
<script  type="text/javascript" >
	...
	$(document).ready(function() {
		...
		$("body").on('click','#btn_add_row',function() {
			...
			html += '<td><input class="form-control" type="number" name="doc_details['+x+'][product_billing_id]" id="product_billing_id'+x+'" data-value="'+x+'"></td>';
		...
		//Tính thành tiền khi nhập giá trị đã thêm
			function thanh_tien_x (x){
				var gia_tri = $('#gia_tri'+x+'').val();
				var gia_tri_vat = $('#gia_tri_vat'+x+'').val();
				var thanh_tien = parseInt(gia_tri) + parseInt(gia_tri_vat);
