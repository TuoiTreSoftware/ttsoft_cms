	...
	<div class="row page-titles">
		...
		<div class="col-md-7 align-self-center text-right">
			<div class="d-flex justify-content-end align-items-center">
				<a href="{{ route('accounting.phieu_thu.get.list') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-arrow-left"></i> Danh sách phiếu thu</a>
			</div>
		</div>
	</div>
	<div class="row">
									...
									<table class="table table-hover table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td colspan="2"><input type="" name="total" class="total form-control" style="color: red;" readonly="" value="{{ getTotalDocHeadersById($data->getId()) }}"></td>
...
<script  type="text/javascript" >
	...
	$(document).ready(function() {
		...
		$("#btn_add_row").click(function() {
			...
			html += '<td><input class="form-control change-giatri-vat" type="number" name="doc_details['+x+'][gia_tri_vat]" id="gia_tri_vat'+x+'" data-value="'+x+'"></td>';
