...
<div class="container-fluid">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h4 class="text-themecolor">Thêm Mới Phiếu Báo Có Ngân Hàng</h4>
		</div>
		<div class="col-md-7 align-self-center text-right">
			<div class="d-flex justify-content-end align-items-center">
				<a href="{{ route('accounting.bao_co.get.list') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Danh sách phiếu báo có ngân hàng</a>
			</div>
		</div>
	</div>
	<div class="row">
					...
					<form method="post" action="" id="my-form">
						...
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="doc_code" class="form-control" id="inputDoc_code" placeholder="Số phiếu nhập kho" value="BCNH{{ Carbon\Carbon::now()->year }}{{ Carbon\Carbon::now()->month }}" readonly="">
							</div>
							<div class="form-group col-md-4">
							...
							<div class="form-group col-md-4">
								<label for="inputBankaccounts" class=" control-label col-form-label">Tình trạng</label>
								<select class="form-control" id="inputBankaccounts" name="bank_accounts">
									<option value="0">Chọn tài khoảng ngân hàng</option>
									{{ get_category_by_prefix('BANK','',0,'') }}
								</select>
							</div>
							<div class="form-group col-md-4">
									...
									<table class="table table-hover table-bordered">
										...
										<tbody>
											<tr>
												...
												<td><button type="button" href="javascript:void(0)" id="" class="btn btn-danger btn_clear btn-sm">Xóa</button></td>
											</tr>
											<tr id="add_html">
												<td colspan="7">
