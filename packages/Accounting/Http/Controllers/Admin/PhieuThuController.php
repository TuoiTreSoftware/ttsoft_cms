...
use Carbon\Carbon;
use TTSoft\Inventories\Entities\PT;
...
class PhieuThuController extends Controller
{
    ...
    public function getList(){
    	$data = PT::findAll();
        return view("accounting::phieu_thu.list",compact('data'));
    }

    public function getCreate(){
    	$data = Customer::findAll();
    	return view("accounting::phieu_thu.create",compact('data'));
    }
    public function postCreate(Request $request){
        ...
        $data->doc_code = PT::PREFIX.$carbon->year.$carbon->month.$data->id;
        $data->save();
        //insert doc_details;
        ...
        return redirect()->route('accounting.phieu_thu.get.list');
    }
    public function getEdit($id){
        $data = PT::findById($id);
        $parent = Customer::findAll();
        return view("accounting::phieu_thu.edit",compact('data','parent'));
    }
