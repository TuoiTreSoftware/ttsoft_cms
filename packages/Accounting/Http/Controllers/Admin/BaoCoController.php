...
class BaoCoController extends Controller
{
    ...
    public function getList(){
    	$data = BCNH::findAll();
        return view("accounting::bao_co_ngan_hang.list",compact('data'));
    }

    public function getCreate(){
    	$data = Customer::findAll();
    	return view("accounting::bao_co_ngan_hang.create",compact('data'));
    }
    public function postCreate(Request $request){
        ...
        $data->doc_code = BCNH::PREFIX.$carbon->year.$carbon->month.$data->id;
        $data->save();
        //insert doc_details;
        ...
        return redirect()->route('accounting.bao_co.get.list');
    }
    public function getEdit($id){
        $data = BCNH::findById($id);
        $parent = Customer::findAll();
        return view("accounting::bao_co_ngan_hang.edit",compact('data','parent'));
    }
