...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        //\TTSoft\Accounting\Console\SettingBconnectCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Accounting\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Accounting\Providers\BaseEventServiceProvider::class,
    ];
    /**
