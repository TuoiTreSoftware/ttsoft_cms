...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\User\Console\SettingBconnectCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\User\Providers\BaseRouteServiceProvider::class,
        \TTSoft\User\Providers\BaseEventServiceProvider::class,
    ];
    /**
