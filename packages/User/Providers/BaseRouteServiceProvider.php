...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\User\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\User\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\User\Http\Controllers\Admin';
