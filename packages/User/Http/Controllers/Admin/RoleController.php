...
class RoleController extends Controller
{
    ...
    {
        $roles = Role::orderBy('id','DESC')->paginate(env('PAGINATE_PAGER'));
    ...
    {
        $permission =  DB::table('permission_group')->get();
        return view('user::roles.create',compact('permission'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user::roles.edit',compact('role','permission','rolePermissions'));
    }
