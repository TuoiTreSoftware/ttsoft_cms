...
<div class="container-fluid">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h4 class="text-themecolor">Danh Phiếu Trả Hàng</h4>
		</div>
		<div class="col-md-7 align-self-center text-right">
			<div class="d-flex justify-content-end align-items-center">
				<a href={{ route('sales.get.tra_hang_ban.add') }} class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Tạo Phiếu Trả Hàng</a>
			</div>
		</div>
	</div>
	<div class="row">
						...
						<table class="table table-bordered table-hover product-overview">
							...
							<tbody>
								...
								<tr>
									...
									<td>10-7-2017</td>
									<td><a href="#">Phiếu trả hàng RT001</a></td>
									<td class="text-right"><a href="#">1.000.000 đ</a></td>
									<td>Lỗi nhà cung cấp</td>
									<td>Nguyễn Văn A</td>
