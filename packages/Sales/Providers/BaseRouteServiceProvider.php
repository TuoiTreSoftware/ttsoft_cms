...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\Sales\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\Sales\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\Sales\Http\Controllers\Admin';
