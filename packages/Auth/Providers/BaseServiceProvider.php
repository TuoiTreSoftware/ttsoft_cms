...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\Auth\Console\SettingBconnectCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Auth\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Auth\Providers\BaseEventServiceProvider::class,
    ];
    /**
