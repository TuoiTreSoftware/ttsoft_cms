...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\Auth\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\Auth\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\Auth\Http\Controllers\Admin';
