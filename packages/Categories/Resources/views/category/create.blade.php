...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<form method="POST" action="{{ route('categories.post.create',$category) }}" id="my-form">
						{{ csrf_field() }}
						@if(count($errors)>0)
