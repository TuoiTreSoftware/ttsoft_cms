                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" class="form-control" name="title" placeholder="Tên danh mục" value="{{ $content->title or old('title') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="parent_id" class="form-control" name="parent_id">
                                        ...
                                        {{ get_product_category($ref_lang,'',$data->parent_id) }}
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="description">Mô tả</label>
                                    <textarea id="description" class="form-control" name="content" rows="6" placeholder="Thêm mô tả ...">{{ $content->content or old('content') }}</textarea>
                                </div>
                            </div>
