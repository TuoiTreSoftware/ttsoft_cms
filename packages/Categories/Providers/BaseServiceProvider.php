...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\Categories\Console\SettingBconnectCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Categories\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Categories\Providers\BaseEventServiceProvider::class,
    ];
    /**
