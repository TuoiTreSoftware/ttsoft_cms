...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\Setting\Console\SettingCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Setting\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Setting\Providers\BaseEventServiceProvider::class,
    ];
    /**
