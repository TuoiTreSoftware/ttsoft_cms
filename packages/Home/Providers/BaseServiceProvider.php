...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\Home\Console\HomeCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Home\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Home\Providers\BaseEventServiceProvider::class,
    ];
    /**
    ...
    public function boot()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../Config/config.php', 'home');
    }
    /**
