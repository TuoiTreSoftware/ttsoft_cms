	                    	...
	                    	<div class="row">
	                    		<div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control slug" id="example-text-slug" placeholder="Enter Name" name="URL"> 
                                    </div>
                                    <div class="form-group">
                                    ...
                                    {!! fileUploadSingle($nameFile = 'image' , $folder = 'slider') !!}
                                    <p>Hình ảnh tối ưu tỷ lệ 16:9 kích thước 1920px x 768px</p>
	                    		</div>

	                    	</div>
	                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">{{ trans('Create Slider') }}</button>
