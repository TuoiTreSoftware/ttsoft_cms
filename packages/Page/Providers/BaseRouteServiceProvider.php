...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\Page\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\Page\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\Page\Http\Controllers\Admin';
