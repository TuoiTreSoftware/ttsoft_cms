<?php
namespace TTSoft\Promotions\Providers;
...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        //\TTSoft\Promotions\Console\SettingBconnectCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Promotions\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Promotions\Providers\BaseEventServiceProvider::class,
    ];
    /**
    ...
    public function boot()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../Config/config.php', 'promotion');
    }
    /**
