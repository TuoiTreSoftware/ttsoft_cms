...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\Dashboard\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\Dashboard\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\Dashboard\Http\Controllers\Admin';
