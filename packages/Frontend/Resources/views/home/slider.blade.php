@if(get_slider())
<section id="slider" class="slider-element swiper_wrapper clearfix full-screen" data-loop="true" data-speed="5000" data-autoplay="true">
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				@foreach(get_slider(\TTSoft\Slider\Entities\Slider::CATEGORY_HOME) as $sliderData)
