<?php
namespace TTSoft\Frontend\Providers;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    protected $routeMiddleware = [
        'frontend_lang' => \TTSoft\Frontend\Http\Middleware\LanguageFrontendMiddleware::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Frontend\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Frontend\Providers\BaseEventServiceProvider::class,
    ];
    /**
