...
class BaseRouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespaceWeb = 'TTSoft\Base\Http\Controllers\Web';

    protected $namespaceApi = 'TTSoft\Base\Http\Controllers\Api';

    protected $namespaceAdmin = 'TTSoft\Base\Http\Controllers\Admin';
