...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        //\TTSoft\Inventories\Console\SettingBconnectCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\Inventories\Providers\BaseRouteServiceProvider::class,
        \TTSoft\Inventories\Providers\BaseEventServiceProvider::class,
    ];
    /**
