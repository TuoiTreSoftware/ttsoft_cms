...
class BaseServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        \TTSoft\About\Console\AboutCommand::class,
    ];
    /**
    ...
    protected $registerProvider = [
        \TTSoft\About\Providers\BaseRouteServiceProvider::class,
        \TTSoft\About\Providers\BaseEventServiceProvider::class,
    ];
    /**
    ...
    public function boot()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../Config/config.php', 'about');
    }
    /**
