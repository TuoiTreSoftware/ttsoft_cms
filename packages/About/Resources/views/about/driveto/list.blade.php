...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">{{ trans('Nội dung') }}</h5>
					<div class="table-responsive">
						<table class="table table-bordered table-hover product-overview">
							...
							<tbody>
								@if($driveto)
									@foreach($driveto as $key => $data)
									@if($data->getSlug() == \TTSoft\About\Entities\About::DRIVE_YOU_TO_SUCCESS)
										<tr>
											...
											<td>
												<a href="{{ route('admin.About.get.edit',$data->getURLKey()) }}" class="text-dark p-r-10" data-toggle="tooltip" title="Edit">
													<i class="ti-marker-alt"></i>
												</a>
												<a href="{{ route('admin.About.get.view',$data->getId()) }}" class="text-dark p-r-10" data-toggle="tooltip" title="View">
													<i class="icon-eye"></i>
												</a>
										</tr>
									@endif
